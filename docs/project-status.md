...
This checkout is `feat/v0.2-single-user-release`. Preserve all implementation WIP; this policy-only update does not certify, merge or deploy its application changes. Latest recorded production checkpoint is project rooms `584c3fc6f45dbc60cc8768ecd39c59e92cd219f8`; check live state before operating. Current product work is room-workspace usability in `feat/room-workspace-usability`.
