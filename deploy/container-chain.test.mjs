...
function fixture(files = new Map(), forward) {
  ...
  runInNewContext(source, {
    ...
    https: (_options, callback) => { transport = callback; return { listen() {} }; }, forward,
  });
  return { transport, async request(method, path, body, key = 'jc-v1-' + '1'.repeat(64)) {
    let status, text = '';
